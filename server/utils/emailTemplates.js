...
export const generateAppointmentConfirmationTemplate = (
  ...
  return `
    ...
    <head>
        <meta charset="utf-8">
        <title>Appointment Confirmed - EV Service Center</title>
        <style>
            body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
            .container { max-width: 600px; margin: 0 auto; padding: 20px; }
            ...
            .content { background: #f9fafb; padding: 30px; border-radius: 0 0 10px 10px; }
            .confirmation-badge { background: #3b82f6; color: white; font-size: 18px; font-weight: bold; text-align: center; padding: 15px; border-radius: 8px; margin: 20px 0; }
            .appointment-details { background: white; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #3b82f6; }
            .service-center { background: #f3f4f6; padding: 15px; border-radius: 6px; margin: 10px 0; }
            .footer { text-align: center; color: #6b7280; font-size: 14px; margin-top: 20px; }
            ...
            <div class="content">
                ...
                <div class="appointment-details">
                    ...
                    <div class="service-center">
                        ...
                        <p><strong>Name:</strong> ${serviceCenter.name}</p>
                ...
                <ul>
                    ...
                    <li>Bring your vehicle registration and ID</li>
                ...
                <div style="text-align: center;">
                    <a href="${
                      process.env.CLIENT_URL
                    }/appointments" class="button">View Appointment Details</a>
                </div>
