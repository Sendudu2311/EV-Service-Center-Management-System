      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {(!vehicles || vehicles.length === 0) ? (
          <div className="mt-8 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500">Get started by adding your first electric vehicle.</p>
            <div className="mt-6">
              <button
                type="button"
                onClick={handleCreateVehicle}
          ...
          <div className="mt-8 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {(vehicles || []).map((vehicle) => (
              <div
                key={vehicle._id}
                className="relative bg-white overflow-hidden shadow rounded-lg divide-y divide-gray-200"
              >
                ...
                <div className="px-6 py-3 bg-gray-50">
                  <div className="flex justify-between">
                    <button
                      ...
                      className="inline-flex items-center gap-x-1.5 text-sm font-semibold text-blue-600 hover:text-blue-500"
                    >
                    ...
                    <div className="flex space-x-2">
                      <button
                        ...
                        className="inline-flex items-center gap-x-1.5 text-sm font-semibold text-gray-600 hover:text-gray-500"
                      >
