        ...
        <div className="bg-white rounded-lg shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="text-gray-700">To use certain features of the Service, you must register for an account and provide accurate information:</p>
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">4. Service Usage</h2>
            <div className="space-y-4">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="text-gray-700">Appointment booking and management is subject to the following terms:</p>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
          ...
          <section>
            ...
            <div className="space-y-4">
              <p className="text-gray-700">Payment for services is governed by the following terms:</p>
              <ul className="list-disc list-inside text-gray-700 space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Warranties and Liability</h2>
            <div className="space-y-4">
              <h3 className="text-lg font-semibold text-gray-900">Service Warranties</h3>
              <ul className="list-disc list-inside text-gray-700 space-y-1 ml-4">
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-lg p-4">
              <p className="text-gray-700"><strong>Email:</strong> legal@evservicecenter.com</p>
              <p className="text-gray-700"><strong>Phone:</strong> +84 123 456 789</p>
              <p className="text-gray-700"><strong>Address:</strong> 123 EV Service Center, Ho Chi Minh City, Vietnam</p>
            </div>
          </section>
