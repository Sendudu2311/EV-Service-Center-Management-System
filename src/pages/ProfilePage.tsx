                  ...
                  {!editing ? (
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="inline-flex items-center px-3 py-2 border border-transparent shadow-sm text-sm leading-4 text-dark-900 bg-lime-600 hover:bg-lime-500 transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-dark-900 focus:ring-lime-400 focus:ring-offset-dark-900 disabled:opacity-50"
                      >
                  ...
                  {!changingPassword ? (
                    ...
                    <div className="flex space-x-3">
                      <button
                        type="submit"
                        disabled={loading}
                        className="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm text-dark-900 bg-lime-600 hover:bg-lime-500 transition-all duration-200 transform hover:scale-105 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-dark-900 focus:ring-lime-400 focus:ring-offset-dark-900 disabled:opacity-50"
                      >
