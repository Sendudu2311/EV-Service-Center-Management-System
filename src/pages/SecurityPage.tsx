      ...
      <div className="max-w-4xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3">Compliance & Auditing</h3>
            <p className="text-gray-700">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Our Security Measures</h2>
          ...
          <div className="space-y-6">
            ...
            <div className="border-l-4 border-orange-500 pl-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-2">Monitoring & Response</h3>
              <ul className="text-gray-700 space-y-1">
        ...
        <div className="bg-gray-100 rounded-lg p-8 mb-12">
          <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">Certifications & Standards</h2>

          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-3">
                <span className="text-blue-600 font-bold text-lg">ISO</span>
              </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Report Security Concerns</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-gray-700 text-sm mb-2">security@evservicecenter.com</p>
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <p className="text-gray-700 text-sm mb-2">+84 987 654 321</p>
                <p className="text-gray-600 text-xs">24/7 availability</p>
              </div>
            </div>
