              ...
              <Dialog.Panel className="w-full max-w-4xl transform overflow-hidden rounded-2xl bg-dark-300 p-6 text-left align-middle shadow-xl transition-all">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="border-t pt-6">
                    <h4 className="text-lg text-text-muted text-white mb-4">Pricing</h4>
                  ...
                  {/* Inventory */}
                  <div className="border-t pt-6">
                    <h4 className="text-lg text-text-muted text-white mb-4">Inventory</h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div>
                        <label className="block text-sm text-text-muted text-text-secondary mb-2">
                          Current Stock
                  ...
                  {/* Warranty */}
                  <div className="border-t pt-6">
                    <h4 className="text-lg text-text-muted text-white mb-4">Warranty</h4>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div>
                        <label className="block text-sm text-text-muted text-text-secondary mb-2">
                          Duration (months)
                  ...
                  {/* Images */}
                  <div className="border-t pt-6">
                    <h4 className="text-lg text-text-muted text-white mb-4">Images</h4>
                    ...
                    <div className="space-y-4">
                      ...
                      <label className="flex items-center">
                        <input
                          ...
                          className="rounded bg-dark-300 text-white border-dark-300 text-lime-600 focus:ring-lime-400"
                        />
                        <span className="ml-2 text-sm text-text-secondary">Recommended</span>
                      </label>
                      ...
                      <label className="flex items-center">
                        <input
                          ...
                          className="rounded border-dark-300 text-red-600 focus:ring-red-500"
                        />
                        <span className="ml-2 text-sm text-text-secondary">Discontinued</span>
                      </label>
                    </div>
                  </div>
